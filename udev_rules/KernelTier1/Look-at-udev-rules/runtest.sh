...
rlJournalStart
    ...
    rlPhaseStartTest
        ...
        rlRun "[ -x /mnt/tests/kernel/udev_rules/KernelTier1/Look-at-udev-rules/check_for_udev.sh ] && /mnt/tests/kernel/udev_rules/KernelTier1/Look-at-udev-rules/check_for_udev.sh" 0 "test max_sectors_kb"
    rlPhaseEnd
